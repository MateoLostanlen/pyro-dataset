...
Use Github [issues](https://github.com/pyronear/pyro-dataset/issues) for feature requests, or bug reporting. When doing so, use issue templates whenever possible and provide enough information for other contributors to jump in.
